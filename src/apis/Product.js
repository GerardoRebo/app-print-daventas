...
export default {
    ...
    register_service(product_form) {

        return Api().post("/products/register_service", product_form);
    ...
    ajustar(prodcutActualId, almacenActualId, product_form) {
        ...
        return Api().put(`/products/ajustar/${prodcutActualId}/${almacenActualId}`, product_form)

    },
    ajustarGeneral(prodcutActualId, almacenActualId, product_form) {

        return Api().put(`/products/ajustarGeneral/${prodcutActualId}/${almacenActualId}`, product_form)

    },
    ajustarMinMax(prodcutActualId, almacenActualId, product_form) {

        return Api().put(`/products/ajustarminmax/${prodcutActualId}/${almacenActualId}`, product_form)
    ...
    search(page, keyword, almacenActualId, departamentoActualId, proveedorActualId, bajostock, prioritario, todos) {
